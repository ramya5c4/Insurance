...
model = joblib.load("D:\\ML\\project\\regression.joblib")

scaler_object = joblib.load("D:\\ML\\project\\scaler.joblib")
...
def preprocess_input(input_dict):
    ...
    expected_columns = [
        'age', 'number_of_dependants', 'income_lakhs', 'insurance_plan','normalize_risk_score', 'disease_risk_score',
